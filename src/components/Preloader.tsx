...
function MatrixRain() {
  ...
  useEffect(() => {
    ...
    const chars =
      "01{}[]<>/=+*#%&$@;:~^!?abcdefABCDEF0123456789".split("");
    ...
    if (prefersReducedMotion()) {
      ...
      for (let i = 0; i < 70; i++) {
        ...
        ctx.fillStyle =
          `rgba(93,240,138,${0.04 + Math.random() * 0.1})`;
    ...
    const draw = (t: number) => {
      ...
      cols.forEach((c) => {
        ...
        ctx.fillStyle = bright
          ? "rgba(93,240,138,0.85)"
          : "rgba(93,240,138,0.28)";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(93,240,138,0.18), transparent 70%)",
        }}
        aria-hidden="true"
      />
      ...
      >
        ...
        <div
          className="
            ...
            bg-ink/70
            p-6
            shadow-[0_30px_90px_-20px_rgba(0,0,0,0.9)]
            backdrop-blur-[3px]
          "
        >
          ...
          >
            ...
            <div
              className="
                h-full
                bg-acid
                shadow-[0_0_14px_rgba(93,240,138,0.8)]
                transition-[width]
                duration-150
                ease-out
              "
